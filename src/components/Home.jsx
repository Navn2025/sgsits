import { Calendar, ChevronRight, Download, BookOpen, GraduationCap, Microscope, Award, Users, Building, FileText, ArrowRight } from 'lucide-react';

export default function Home() {
  return (
    <div className="flex flex-col">
      {/* 3. HERO SECTION */}
      <section className="relative w-full h-[500px] md:h-[600px] bg-primary overflow-hidden">
        {/* Background Image injected via Customizer CSS vars */}
        <div className="absolute inset-0 w-full h-full bg-black">
          <div className="w-full h-full bg-cover bg-center opacity-70" style={{ backgroundImage: "var(--hero-img-url)" }}></div>
          <div className="absolute inset-0 bg-primary/40"></div>
        </div>
        
        <div className="relative z-10 max-w-7xl mx-auto px-4 h-full flex flex-col justify-center items-start">
          <div className="max-w-2xl text-white">
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 text-shadow-md">
              Excellence in Technical Education Since 1952
            </h2>
            <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-xl font-medium tracking-wide">
              A Premier Government Aided Autonomous Institute, fostering innovation and technical leadership under GoMP.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <button className="bg-accent text-primary px-6 py-2.5 font-bold hover:bg-yellow-500 transition-colors shadow-md flex items-center justify-center">
                <FileText size={18} className="mr-2" /> Mandatory Disclosure
              </button>
              <button className="bg-transparent border-2 border-white text-white px-6 py-2.5 font-bold hover:bg-white hover:text-primary transition-colors shadow-md flex items-center justify-center">
                <Award size={18} className="mr-2" /> NIRF Data
              </button>
              <button className="bg-transparent border-2 border-white text-white px-6 py-2.5 font-bold hover:bg-white hover:text-primary transition-colors shadow-md flex items-center justify-center">
                <FileText size={18} className="mr-2" /> Tenders
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white border-b shadow-sm w-full py-3">
        <div className="max-w-7xl mx-auto px-4 flex items-center">
          <div className="bg-red-600 text-white font-bold px-4 py-1 text-sm shrink-0 uppercase tracking-wider">
            Latest Updates
          </div>
          <div className="overflow-hidden ml-4 relative w-full text-sm font-medium text-gray-700">
            {/* Note: Simple static text for structured layout, can be made marquee using minimal CSS if required */}
            <div className="flex space-x-8 truncate">
              <span className="flex items-center"><ChevronRight size={16} className="text-primary mr-1"/> B.Tech Admissions 2024 cutoff released.</span>
              <span className="hidden md:flex items-center"><ChevronRight size={16} className="text-primary mr-1"/> Registration for Even Semester begins next week.</span>
              <span className="hidden lg:flex items-center"><ChevronRight size={16} className="text-primary mr-1"/> End semester examination schedule published.</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="bg-primary text-white py-12 border-t-4 border-accent">
        <div className="max-w-7xl mx-auto px-4">
      ...
      {/* 10. CAMPUS LIFE */}
      <section className="py-16 bg-sgsits-bg">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
